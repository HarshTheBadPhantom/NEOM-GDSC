...
extension ThemeExtension on ThemeData {
  Color get colorPrimary => brightness == Brightness.dark
      ? const Color.fromARGB(255, 191, 228, 168)
      : const Color.fromARGB(255, 191, 228, 168);
  Color get colorSecondary => brightness == Brightness.dark
      ? const Color.fromARGB(255, 249, 232, 226)
      : const Color.fromARGB(255, 249, 232, 226);
  ...
  TextStyle get kMedTextStyle => GoogleFonts.nunito(
      fontWeight: FontWeight.w800, fontSize: 30);
  TextStyle get kTitleTextStyle => GoogleFonts.nunito(
      fontWeight: FontWeight.w800,
      color: btnTextCol,
      fontSize: 25);
  TextStyle get kSubTitleTextStyle => GoogleFonts.nunito(
      fontSize: 17, fontWeight: FontWeight.w500);
  TextStyle get kNormalTextStyle => GoogleFonts.nunito(
     fontSize: 20, fontWeight: FontWeight.w700);
  TextStyle get kSmallTextStyle => GoogleFonts.nunito(
